    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                ...
                fun tmpAddDelay(holder: RecyclerView.ViewHolder) :Long {
                    return 600
                }
                fun tmpRemoveDelay(holder: RecyclerView.ViewHolder) :Long {
                    return 0
                }
                (recyclerView.itemAnimator!! as BaseItemAnimator).setAddDelay(::tmpAddDelay)
                (recyclerView.itemAnimator!! as BaseItemAnimator).setRemoveDelay(::tmpRemoveDelay)
            }
